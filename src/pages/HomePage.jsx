    ...
    <div className="sonic-bg min-h-screen text-slate-100">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20 pb-8">
        <div className="relative z-10 text-center container mx-auto px-4 max-w-4xl">
          ...
          <h1 className="text-[8vw] sm:text-4xl md:text-6xl mb-3 font-bold pixel-glow-text text-yellow-300 whitespace-nowrap" style={{ fontFamily: "'Press Start 2P', cursive" }}>
            MEDRENALINE
          </h1>

          <p className="text-lg sm:text-2xl md:text-4xl mb-6 max-w-2xl mx-auto text-cyan-100" style={{ fontFamily: "'VT323', monospace" }}>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="retro-panel p-5 sm:p-8 md:p-10">
              ...
              <p className="text-lg sm:text-xl md:text-3xl mb-4 sm:mb-6 leading-relaxed text-slate-100" style={{ fontFamily: "'VT323', monospace" }}>
              ...
              <p className="text-lg sm:text-xl md:text-3xl leading-relaxed text-slate-100" style={{ fontFamily: "'VT323', monospace" }}>
